...
def compare(dir_name, input1_path, input2_path):
    ...
    if LOGGING:
        ...
        print()
        print('------------------------------------Completeness-V2--------------------------------------------')
        print("\t                           Average:", raw_completeness_without_variables(may, input1, input2),
              'vs', raw_completeness_without_variables(generalization, input1, input2))
    ...
    f.write(f"{category}, {template}, {category_base_name} {input1_number} vs {input2_number}, {is_similar}, "
            ...
            f"{raw_completeness_without_variables(may, input1, input2)},{raw_completeness_without_variables(generalization, input1, input2)},"
