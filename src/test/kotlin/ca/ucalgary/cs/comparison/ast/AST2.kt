...
class AST2 : BaseCompareGraphTest() {
    override fun initializeGraphs() {
        ...
        graph1.visualize("SimpleV2/G1")
        graph2.visualize("SimpleV2/G2")
    }

    override fun checkCommonGraph(commonGraph: Graph) {
        graph1.visualize("SimpleV2/G1_generalized", commonGraph)
        graph2.visualize("SimpleV2/G2_generalized", commonGraph)
        commonGraph.visualize("SimpleV2/Generalization")
    }

    override fun checkGraph1Diff(graph1Diff: Graph) {
        graph1Diff.visualize("SimpleV2/G1_Diff")
    }
    override fun checkGraph2Diff(graph2Diff: Graph) {
        graph2Diff.visualize("SimpleV2/G2_Diff")
    }
}