...
class TwitterUserTest : BaseCompareGraphTest() {
    ...
    override fun checkCommonGraph(commonGraph: Graph) {
        ...
        ASTPrinter.from(commonGraph, fileName = "TwitterUser2vs15/Generalization_F", graph1, graph2)
        ASTPrinter.from(commonGraph, fileName = "TwitterUser2vs15/Generalization_S", graph2, graph1)
