...
class SampleTest : BaseCompareGraphTest() {
    ...
    override fun initializeGraphs() {
        ...
        graph1 = GraphScanner.scan("src/test/kotlin/ca/ucalgary/cs/comparison/call_graph/elasticsearch/elasticsearch-7.17.12.txt")
        graph2 = GraphScanner.scan("src/test/kotlin/ca/ucalgary/cs/comparison/call_graph/elasticsearch/elasticsearch-8.9.1.txt")
    }
