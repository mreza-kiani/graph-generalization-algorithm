...
class EclipseDomTest : BaseCompareGraphTest() {
    override fun initializeGraphs() {
        ...
        graph2 = GraphScanner.scan("src/test/kotlin/ca/ucalgary/cs/comparison/dependency_graph/eclipse_dom/3.12.txt")
...
//        graph2.visualize("junit5")
    ...
    override fun checkGraph1Diff(graph1Diff: Graph) {
        graph1Diff.visualize("eclipse-dom-3.12-differences")
    }

    override fun checkGraph2Diff(graph2Diff: Graph) {
        graph2Diff.visualize("eclipse-dom-3.27-differences")
    }
}
